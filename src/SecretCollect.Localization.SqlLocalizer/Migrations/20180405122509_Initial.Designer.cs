...
namespace SecretCollect.Localization.SqlLocalizer.Migrations
{
    ...
    [Migration("20180405122509_Initial")]
            ...
            modelBuilder.Entity("SecretCollect.Localization.SqlLocalizer.Data.SupportedCulture", b =>
                {
                    ...
                    b.Property<string>("LanguageCode2")
                        .IsRequired()
                        .HasMaxLength(2);

                    b.Property<string>("RegionCode2");

                    b.HasKey("Id");

                    b.HasIndex("LanguageCode2", "RegionCode2")
                        .IsUnique()
                        .HasFilter("[LanguageCode2] IS NOT NULL");
